...
@EnableZuulProxy
public class PruebaJHipster2App {

    private static final Logger log = LoggerFactory.getLogger(PruebaJHipster2App.class);

    private final Environment env;

    public PruebaJHipster2App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes pruebaJHipster2.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PruebaJHipster2App.class);
