...
describe('Bank e2e test', () => {
    ...
    it('should load Banks', () => {
        ...
        expect(bankComponentsPage.getTitle()).toMatch(/pruebaJHipster2App.bank.home.title/);
    ...
    it('should load create Bank dialog', () => {
        ...
        expect(bankDialogPage.getModalTitle()).toMatch(/pruebaJHipster2App.bank.home.createOrEditLabel/);
