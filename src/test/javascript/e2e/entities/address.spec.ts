...
describe('Address e2e test', () => {
    ...
    it('should load Addresses', () => {
        ...
        expect(addressComponentsPage.getTitle()).toMatch(/pruebaJHipster2App.address.home.title/);
    ...
    it('should load create Address dialog', () => {
        ...
        expect(addressDialogPage.getModalTitle()).toMatch(/pruebaJHipster2App.address.home.createOrEditLabel/);
