...
describe('Person e2e test', () => {
    ...
    it('should load People', () => {
        ...
        expect(personComponentsPage.getTitle()).toMatch(/pruebaJHipster2App.person.home.title/);
    ...
    it('should load create Person dialog', () => {
        ...
        expect(personDialogPage.getModalTitle()).toMatch(/pruebaJHipster2App.person.home.createOrEditLabel/);
